...
namespace DeviceTwins.Fabric.DeviceActor
{
    ...
    internal class DeviceActor : Actor, IDeviceActor
    {
        ...
        public async Task<Telemetry> GetTelemetry()
        {
            return await this.StateManager.GetStateAsync<Telemetry>("DeviceState");
        }

        public async Task SaveTelemetry(Telemetry telemetry)
        {
            await this.StateManager.SetStateAsync("DeviceState", telemetry);
        }
